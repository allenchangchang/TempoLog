...
data.msg = torch.cat((data.msg, data.level.unsqueeze(-1)), dim=-1)
...
memory_dim = 1024
time_dim = embedding_dim = 300     # 300 for spirit
...
for epoch in range(1, 101):
    ...
    val_f1, val_p, val_r = test(val_loader)
    test_f1, test_p, test_r = test(test_loader)
